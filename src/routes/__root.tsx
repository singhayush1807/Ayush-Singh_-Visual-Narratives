...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ayush Singh — Video Editor & Motion Designer" },
      {
        name: "description",
        content:
          "Ayush Singh is a video editor and motion designer crafting scroll-stopping gaming, documentary and short-form content.",
      },
      { name: "author", content: "Ayush Singh" },
      { property: "og:title", content: "Ayush Singh — Video Editor & Motion Designer" },
      {
